...
import com.othmen.users.service.UserService;
...
public class UsersMicroserviceApplication {
	 ...
	 * User(null,"othmen","123",true,null)); userService.saveUser(new
	 * User(null,"manna","123",true,null));
	 * 
